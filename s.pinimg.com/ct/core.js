! function(t) {
    ...
    var r, o, i;
    r = document, o = t(0), i = t(2), (t = r.createElement("script")).async = !0, i.setVersion("916e7af4"), o.isInRampPercentage(o.LIST.SEND_LOGS.chance) && (t.onerror = function() {
        i.error("Failed to load ".concat("916e7af4"), new Error("failed to load main.js"))
    }), t.src = "https://s.pinimg.com/ct/lib/main.916e7af4.js", (o = r.getElementsByTagName("script")[0]).parentNode.insertBefore(t, o)
}, function(n, e, t) {
    var r = t(0),
        o = {},
        i = "unknown";
